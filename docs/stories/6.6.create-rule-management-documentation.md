...
- [ ] Task 2: Produce operator checklist (AC: 2, 4)  
  - [ ] Create `docs/rules/rule-change-checklist.md` detailing pre-change, change, and post-change steps (backups, YAML validation, test execution, monitoring signals, rollback triggers, observer assignments). [Source: docs/epics/epic-6-post-mvp-enhancements.md#business-user-rule-management-guide]  
